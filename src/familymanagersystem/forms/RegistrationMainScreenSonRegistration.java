 ...
 * @version 1.0
 */
public class RegistrationMainScreenSonRegistration extends javax.swing.JPanel {

    public RegistrationMainScreenSonRegistration() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jSonNameField = new javax.swing.JTextField();
        ...
        jSonNameField.setBackground(new java.awt.Color(22, 22, 22));
        jSonNameField.setFont(new java.awt.Font("Arial", 0, 13)); // NOI18N
        jSonNameField.setForeground(new java.awt.Color(255, 255, 255));
        jSonNameField.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        jSonNameField.setToolTipText("Introduce the name");
        jSonNameField.setAutoscrolls(false);
        jSonNameField.setBorder(javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, new java.awt.Color(37, 37, 37)));
        jSonNameField.setCaretColor(new java.awt.Color(102, 102, 102));
        jSonNameField.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jSonNameField.setMargin(new java.awt.Insets(2, 5, 2, 2));
        ...
        jBackgroundLayout.setHorizontalGroup(
            ...
            .addGroup(jBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(jBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jSonNameField, javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        jBackgroundLayout.setVerticalGroup(
            ...
            .addGroup(jBackgroundLayout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(18, 18, 18)
                .addComponent(jSonNameField, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(39, 39, 39)
                .addComponent(jLabel2)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Registrates a new Son to the Family
        String sonName = jSonNameField.getText();
        String bornDate = jBornDateField.getText();

        //tests if both field are empty
        if (sonName.isBlank() && bornDate.isBlank()) {
